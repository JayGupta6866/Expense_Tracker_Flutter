...
class Chart extends StatelessWidget {
  ...
  List<BucketExpenses> get buckets {
    return [
      ...
      BucketExpenses.forCategory(expenses, Category.luxury),
      BucketExpenses.forCategory(expenses, Category.travel),
      BucketExpenses.forCategory(expenses, Category.stationary),
      BucketExpenses.forCategory(expenses, Category.rent),
    ];
  }
